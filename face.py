...
def AddLocators(scale):

    headLoc = cmds.spaceLocator(n='Loc_Face_Head')
    cmds.move(0, 371*scale, 8*scale, headLoc)

    centerLoc = cmds.spaceLocator(n='Loc_Face_Center')
    cmds.move(0, 336*scale, -3.5*scale, centerLoc)

    jawEndLoc = cmds.spaceLocator(n='Loc_Face_JawEnd')
    cmds.move(0, 325*scale, 0, jawEndLoc)
